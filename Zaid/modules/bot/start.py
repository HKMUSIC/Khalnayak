...
async def session_flow(_, msg: Message):
    ...
    if step == "awaiting_phone":
        ...
        try:
            ...
            await msg.reply("📨 OTP sᴇɴᴛ! ɴᴏᴡ sᴇɴᴅ ᴛʜᴇ OTP ᴄᴏᴅᴇ ʏᴏᴜ ʀᴇᴄᴇɪᴠᴇᴅ. ɪɴ ᴛʜɪs ғᴏʀᴍᴀᴛ :- 1 2 3 4 (sᴘᴀᴄᴇ ʙʏ sᴘᴀᴄᴇ)")
        except Exception as e:
...
async def complete_login(client: Client, msg: Message, uid: int):
    try:
        ...
        await hosted.start()
        await msg.reply(f"✅ sᴜᴄᴄᴇssғᴜʟʟʏ sᴇssɪᴏɴ ᴀᴜᴛᴏ- ʜᴏsᴛᴇᴅ ᴀs **{user.first_name}**.")
